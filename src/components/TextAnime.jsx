...
const ScrollMarquee = () => {
  ...
  return (
    <div  className="overflow-hidden w-full scrolled-gradient py-1 flex flex-col gap-10">
      ...
      <div
        ref={row1Ref}
        className=" scroll-row flex gap-16 whitespace-nowrap text-[8vw] 
      ...
      <div
        ref={row2Ref}
        className=" mt-[-5vh] md:mt-[-14vh] ml-[-50vw] scroll-row flex gap-16 whitespace-nowrap text-[8vw] font-bold uppercase text-purple-400"
      >
        <span>. Modern</span>
        <span>. Standarization</span>
        <span>. Visual</span>
