...
const Myself = () => {
  ...
  return (
    ...
    >
      ...
      {/* About Me Intro */}
      <div className="w-[90vw] ml-[-4vw] md:ml-[-6vw] h-full md:h-[96vh] flex flex-col-reverse md:flex-row">
        <div
          ref={leftSideRef}
        ...
        >
          ...
          {/* <button className="relative left-[-24vw] md:left-0 mx-5 px-8 py-4 bg-green-800 hover:bg-green-500 cursor-pointer transition-all ease-in-out duration-300 rounded-2xl text-white/90"> */}
            <a
              ...
              className="relative left-[-24vw] md:left-0 mx-5 px-8 py-4 bg-green-800 hover:bg-green-500 cursor-pointer transition-all ease-in-out duration-300 rounded-2xl text-white/90 flex items-center gap-2"
            >
              Connect <FaWhatsapp />
            </a>
          {/* </button> */}
